...
VALUES
    ...
    ('Croquetas Gatos Adultos Salmon', 'Alimento completo para gatos adultos con salmón real. Proteína de alta calidad y taurina.', 27900.00, 2000, @gatos_id, @gatos_alimento_id, 120, 1, GETUTCDATE()),
